...
<section class="bg-white py-16 sm:py-20">
  <div class="max-w-7xl mx-auto grid gap-10 px-4 sm:px-6 lg:grid-cols-2 lg:px-8">
    <div>
    ...
    <div class="grid gap-4 sm:grid-cols-2">
      ...
      <div class="card rounded-3xl p-6"><i class="fa-solid fa-chart-line text-2xl text-primaryDark"></i><h3 class="mt-4 font-heading font-extrabold">Progress Tracking</h3><p class="mt-2 text-sm text-textMuted">Regular checks to identify improvement areas.</p></div>
      <div class="card rounded-3xl p-6"><i class="fa-solid fa-pen-to-square text-2xl text-primaryDark"></i><h3 class="mt-4 font-heading font-extrabold">Practice System</h3><p class="mt-2 text-sm text-textMuted">Worksheets, tests, and exam-oriented questions.</p></div>
      <div class="card rounded-3xl p-6"><i class="fa-solid fa-handshake-angle text-2xl text-primaryDark"></i><h3 class="mt-4 font-heading font-extrabold">Guided Support</h3><p class="mt-2 text-sm text-textMuted">Personal attention for doubts and planning.</p></div>
    </div>
  </div>
</section>
